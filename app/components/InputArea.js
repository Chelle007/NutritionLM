                ...
                >
                    ...
                    <div className="px-3 pt-3 md:px-4 md:pt-4">
                        <textarea
                            ...
                            className="w-full bg-transparent border-none focus:ring-0 outline-none min-h-[48px] md:min-h-[60px] max-h-40 resize-none text-sm md:text-base text-gray-700 placeholder:text-gray-400"
                            rows={1}
                        />
                    </div>
                    
                    {/* All buttons - below input on mobile, alongside on desktop */}
                    <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 px-3 pb-3 md:pb-3 md:pt-1 border-t border-gray-100 sm:border-t-0 sm:px-4 sm:gap-2">
                        <div className="flex items-center gap-1.5 md:gap-2 flex-wrap">
                            <button 
                                onClick={() => setActiveButton(activeButton === 'factCheck' ? null : 'factCheck')}
                                className="flex items-center gap-1 px-2.5 md:px-3 py-1.5 md:py-1.5 rounded-full text-[11px] md:text-xs font-semibold transition-colors"
                                style={{
                            ...
                            >
                                <Scale className="w-3.5 h-3.5 md:w-4 md:h-4 shrink-0" />
                                Compare
                            </button>
                            ...
                            >
                                <UtensilsCrossed className="w-3.5 h-3.5 md:w-4 md:h-4 shrink-0" />
                                <span className="hidden sm:inline">Nutrition </span>Check
                            </button>
                        </div>

                        <div className="flex items-center gap-2 md:gap-2 justify-end">
                            {/* Trigger File Input */}
                            <button 
                            ...
                            >
                                <Send className="w-4 h-4 md:w-5 md:h-5 md:ml-0.5" />
                            </button>
                        </div>
                    </div>
                </div>
